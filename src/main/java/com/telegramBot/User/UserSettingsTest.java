...
public class UserSettingsTest {
    public static void main(String[] args) {
        ...
        User user1 = new User(12111,  new BankEnum[]{BankEnum.PRIVAT, BankEnum.MONO}, new String[]{"USD", "EUR"}, 2, "17:00");
        ...
        User user2 = new User(8888888,new BankEnum[]{BankEnum.NBU, BankEnum.MONO}, new String[]{"UAH"}, 1, "09:00");
